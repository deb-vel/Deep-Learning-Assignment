    ...
    def __init__(self):
        ...
        with self.graph.as_default():
            ...
            with tf.variable_scope('output'):
                W = tf.get_variable('W', [input_size, output_size], tf.float32, tf.zeros_initializer())
            ...
            self.error = tf.reduce_mean(tf.nn.sparse_softmax_cross_entropy_with_logits(labels=self.targets, logits=tf.matmul(self.images,W) + b))
